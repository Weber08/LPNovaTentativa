    ...
    <body>
        ...
        <form action="ManterFornecedorController?acao=confirmar${operacao}" method="post" name="frmManterFornecedor" onsubmit="return validarFormulario(this)">
            <table>
                <tr>
                    <td>Código:</td> 
                    <td><input type="text" name="txtCodigo" value="${fornecedor.codigo}" <c:if test="${operacao != 'Incluir'}"> readonly</c:if>></td>              
                    <td> Descricao:</td> 
                    <td><input type="text" name="txtDescricao" value="${fornecedor.descricao}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>></td>
                </tr>
                <tr>
